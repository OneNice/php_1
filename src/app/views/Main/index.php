<div class="content">
    <div class="tops">
        <?php foreach ($tops as $top) { ?>
            <div class="item" style="background: url('<?= '/img/upload/' . $top->image ?>'); background-size: cover;">
                <a class="gogo" href="<?= '/event/' . $top->event->alias ?>" >
            ...
            <article class="<?php if(!$event->price) echo 'free';?>">
                ...
                <div class="cont">
                    ...
                    <div class="about">
                        ...
                        <div class="box flex">
                            <div class="geo flex">
                                <?php if($event->place_id) {echo "<img src='/img/geo.png'>" . $event->place->name; } ?>
                            </div>
                            <div class="order">
                                <?php
