                ...
                <div class="card-box">
                        ...
                        <?php foreach ($places as $place) { ?>
                            ...
                            <tr>
                                <td class="text-center">
                                    <button data="<?= $place->id?>" class="m_edit btn btn-outline-success btn-sm btn-icon"><i class=" icon-pencil "></i></button>
                                    <button data="<?= $place->id?>" class="m_delete btn btn-outline-danger btn-sm btn-icon"><i class="fa fa-times"></i></button>
                                </td>
                                <td><?= $place->id?></td>
                                <td><?= $place->name?></td>
                                <td><?= $place->city?></td>
                    ...
                    <script>
                        $('.m_edit').on('click', function () {
                            ...
                            myRedirect("/admin/place/edit", "id", $(this).attr('data'));
                        });
                        $('.m_delete').on('click', function () {
                            ...
                            myRedirect("/admin/place/del", "id", $(this).attr('data'));
                        });
                        $('#m_add').on('click', function () {
                            $(location).attr('href','/admin/place/add');
                        });
