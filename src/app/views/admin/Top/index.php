                ...
                <div class="card-box">
                    ...
                    <table id="foo-addrow" class="table table-striped table-bordered m-b-0 toggle-circle" data-page-size="20">
                        ...
                        <tr>
                            ...
                            <th data-sort-initial="true" data-toggle="true">Картинка</th>
                        </tr>
                        </thead>
                        <tbody>
                        <?php foreach ($tops as $top) { ?>
                            ...
                            <tr>
                                <td class="text-center">
                                    <button data="<?= $top->id?>" class="m_edit btn btn-outline-success btn-sm btn-icon"><i class=" icon-pencil "></i></button>
                                    <button data="<?= $top->id?>" class="m_delete btn btn-outline-danger btn-sm btn-icon"><i class="fa fa-times"></i></button>
                                </td>
                                <td><?= $top->id?></td>
                                <td>
                                <span
                                        ...
                                        data-original-title="<?= $top->event->title?>">
                                    <?= $top->event_id?>
                                </span>
                                </td>
                                <td><?= $top->image?></td>
                    ...
                    <script>
                        $('.m_edit').on('click', function () {
                            ...
                            myRedirect("/admin/top/edit", "id", $(this).attr('data'));
                        });
                        $('.m_delete').on('click', function () {
                            ...
                            myRedirect("/admin/top/del", "id", $(this).attr('data'));
                        });
                        $('#m_add').on('click', function () {
                            $(location).attr('href','/admin/top/add');
                        });
